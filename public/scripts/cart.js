...
function showProduct(data) {
  if (data.length == 0) {
    ...
    img.src =
      "//assets-netstorage.groww.in/web-assets/billion_groww_desktop/prod/build/client/images/cart-empty.5f55a0d3.svg";
    ...
    btnFund.onclick = () => {
      window.location.href = `../Front end/groww_products.html`; //./Front end/groww_home.html
    }; // http://127.0.0.1:5500/Front%20end/groww_products.html
